...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("ASimulatorSystem/icons/bank.png"));
        Image i2 = i1.getImage().getScaledInstance(140, 100, Image.SCALE_SMOOTH);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel ima = new JLabel(i3);
        ima.setBounds(70, 10, 100, 100);
        add(ima);
